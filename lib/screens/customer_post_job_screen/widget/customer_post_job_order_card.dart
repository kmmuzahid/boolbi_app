...
class CustomerMyServiceRequestCard extends StatelessWidget {
  const CustomerMyServiceRequestCard({
    super.key,
  });
  ...
  Widget build(BuildContext context) {
    return Slidable(
      ...
      child: GestureDetector(
        onTap: () {
          Get.toNamed(AppRoutes.customerPostJobMyServiceRequestDetailsScreen);
        },
        child: Padding(
