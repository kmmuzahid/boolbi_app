...
class CustomerMyProjectPostingCard extends StatelessWidget {
  const CustomerMyProjectPostingCard({
    super.key,
  });
  ...
  Widget build(BuildContext context) {
    return Slidable(
      ...
      child: GestureDetector(
        onTap: () {
          Get.toNamed(AppRoutes.customerPostJobMyProjectPostDetailsScreen);
        },
        child: Padding(
