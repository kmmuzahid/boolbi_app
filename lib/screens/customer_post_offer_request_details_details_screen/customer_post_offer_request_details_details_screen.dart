...
class CustomerPostOfferRequestDetailsDetailsScreen extends StatelessWidget {
  const CustomerPostOfferRequestDetailsDetailsScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder(
        init: CustomerPostOfferRequestDetailsDetailsScreenController(),
        builder: (controller) {
          return Scaffold(
