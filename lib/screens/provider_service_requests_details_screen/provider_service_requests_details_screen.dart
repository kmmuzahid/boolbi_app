...
class ProviderServiceRequestsDetailsScreen extends StatelessWidget {
  const ProviderServiceRequestsDetailsScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder(
        init: ProviderServiceRequestsDetailsScreenController(),
        builder: (controller) {
          return Scaffold(
            backgroundColor: AppColors.primaryBackgroud,
            appBar: customerCustomAppBar(title: "Service Request Details"),
                    ...
                    child: Column(
                      children: [
                            ...
                            Expanded(
                              child: GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                      // border:
                                      //     Border.all(color: AppColors.completeReq),
                        ...
                        GestureDetector(
                          onTap: () {
                            Get.toNamed(
                                AppRoutes.providerCreateCounterOfferScreen);
                            // Get.closeAllDialogs();
                          },
                          child: Container(
                            margin: EdgeInsets.all(AppSize.width(value: 5)),
