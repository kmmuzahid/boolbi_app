...
class CustomerCreateProjectPostScreen extends StatelessWidget {
  const CustomerCreateProjectPostScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder(
        init: CustomerCreateProjectPostScreenController(),
        builder: (controller) {
          return Scaffold(
            backgroundColor: AppColors.primaryBackgroud,
            appBar: customerCustomAppBar(title: "Create Projects Posting"),
