...
import 'package:boolbi_app/screens/customer_search_screen/widget/customer_search_screen_card.dart';
...
class CustomerSearchScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<CustomerSearchScreenController>(
      init: CustomerSearchScreenController(),
      builder: (controller) {
        return Scaffold(
          backgroundColor: AppColors.primaryBackgroud,
          appBar: customerCustomAppBar(title: "Searching"),
            ...
            slivers: [
              ...
              SliverList(
                delegate: SliverChildBuilderDelegate(
                  (context, index) {
                    return const CustomerSearchScreenCard();
                  },
