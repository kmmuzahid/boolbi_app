...
class CustomerCreateCounterOfferScreen extends StatelessWidget {
  const CustomerCreateCounterOfferScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder(
        init: CustomerCreateCounterOfferScreenController(),
        builder: (controller) {
          return Scaffold(
