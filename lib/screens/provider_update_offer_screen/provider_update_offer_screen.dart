...
class ProviderUpdateOfferScreen extends StatelessWidget {
  const ProviderUpdateOfferScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder(
        init: ProviderUpdateOfferScreenController(),
        builder: (controller) {
          return Scaffold(
            backgroundColor: AppColors.primaryBackgroud,
            appBar: customerCustomAppBar(title: "Update Offer"),
