...
class ProviderCompletedProjectCard extends StatelessWidget {
  const ProviderCompletedProjectCard({
    super.key,
  });
    ...
    return Slidable(
      ...
      child: GestureDetector(
        onTap: () {
          ...
          Get.toNamed(AppRoutes.providerComnpletedProjectDetailsScreen);
        },
        child: Padding(
