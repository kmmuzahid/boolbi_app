...
class ProviderRunningProjectCard extends StatelessWidget {
  const ProviderRunningProjectCard({
    super.key,
  });
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Get.toNamed(AppRoutes.providerRunningProjectProjectProgressScreen);
      },
      child: Padding(
