...
class CustomerOrderProgessOrderDetailsScreen extends StatelessWidget {
  const CustomerOrderProgessOrderDetailsScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder(
        init: CustomerOrderProgessOrderDetailsScreenController(),
        builder: (controller) {
          return Scaffold(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: GestureDetector(
                      onTap: () {
                        // Get.close();
                        // Get.toNamed(AppRoutes.customerEditProjectPostScreen);
