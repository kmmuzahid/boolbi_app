...
class CustomerEditProjectPostScreen extends StatelessWidget {
  const CustomerEditProjectPostScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder(
        init: CustomerEditProjectPostScreenController(),
        builder: (controller) {
          return Scaffold(
            backgroundColor: AppColors.primaryBackgroud,
            appBar: customerCustomAppBar(title: "Edit Project Post"),
