...
import 'package:boolbi_app/screens/customer_post_offer_request_list_screen/widget/customer_post_offer_request_card.dart';
import 'package:boolbi_app/utils/gap.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import '../../widgets/custom_appbar/user_custom_appbar.dart';

class CustomerPostOfferRequestListScreen extends StatelessWidget {
  const CustomerPostOfferRequestListScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder(
        init: CustomerPostOfferRequestListScreenController(),
        builder: (controller) {
          return Scaffold(
                  ...
                  child:
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return const CustomerPostOfferRequestCard();
                      },
                    ),
                  ),
                ),
