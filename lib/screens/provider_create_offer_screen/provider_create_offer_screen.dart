...
class ProviderCreateOfferScreen extends StatelessWidget {
  const ProviderCreateOfferScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder(
        init: ProviderCreateOfferScreenController(),
        builder: (controller) {
          return Scaffold(
            backgroundColor: AppColors.primaryBackgroud,
            appBar: customerCustomAppBar(title: "Creating Offer"),
