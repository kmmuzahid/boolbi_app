...
class CustomerOfferRequestDetailsScreen extends StatelessWidget {
  const CustomerOfferRequestDetailsScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder(
        init: CustomerOfferRequestDetailsScreenController(),
        builder: (controller) {
          return Scaffold(
                      ...
                      children: [
                        Flexible(
                          child: const Column(
                            ...
                            children: [
                              AppText(
                                data: "Brother's Limited Company",
