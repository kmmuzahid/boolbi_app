...
class ProviderComnpletedProjectDetailsScreen extends StatelessWidget {
  const ProviderComnpletedProjectDetailsScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder(
        init: ProviderComnpletedProjectDetailsScreenController(),
        builder: (controller) {
          return Scaffold(
                ...
                children: [
                    ...
                    child: GestureDetector(
                      onTap: () {
                        Get.toNamed(AppRoutes
                            .customerCompletedProjectDeliveryRequestScreen);
                      },
                      child: Container(
                        alignment: Alignment.center,
                        width: AppSize.size.width,
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: const AppText(
                        data:
                            "The Total Cost is Outlined Below and includes a 5% service fee charged by Bolbi upon acceptance of the offer.",
                        color: AppColors.primary,
                        fontSize: 16,
                        fontWeight: FontWeight.w700,
                      ),
