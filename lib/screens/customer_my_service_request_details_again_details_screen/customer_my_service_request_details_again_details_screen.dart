...
class CustomerMyServiceRequestDetailsAgainDetailsScreen
    extends StatelessWidget {
  const CustomerMyServiceRequestDetailsAgainDetailsScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder(
        init: CustomerMyServiceRequestDetailsAgainDetailsScreenController(),
        builder: (controller) {
          return Scaffold(
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const Gap(height: 20),
                        const AppText(
                          data: "Company Service Description:",
                          color: AppColors.primary,
                          fontSize: 18,
                          fontWeight: FontWeight.w600,
                        ),
                        ...
                        const AppText(
                          data:
                              "- Focused on creating intuitive, user-- centered digital experiences that blend aesthetic appeal with seamless functionality. I design responsive, accessible interfaces for web and mobile apps, ensuring every interaction feels natural and purposeful. \n \nUser research, wireframing, user flows, and prototypes focused on usability and engagement.High-fidelity designs, interactive elements, and design systems with a keen eye for visual balance and consistency.",
                          color: AppColors.primary,
                          fontSize: 15.5,
                          fontWeight: FontWeight.w500,
                        ),
