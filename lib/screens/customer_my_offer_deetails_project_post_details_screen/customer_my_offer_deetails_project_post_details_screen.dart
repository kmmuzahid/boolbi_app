...
class CustomerMyOfferDeetailsProjectPostDetailsScreen extends StatelessWidget {
  const CustomerMyOfferDeetailsProjectPostDetailsScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder(
        init: CustomerMyOfferDeetailsProjectPostDetailsScreenController(),
        builder: (controller) {
          return Scaffold(
            backgroundColor: AppColors.primaryBackgroud,
            appBar: customerCustomAppBar(title: "View Projects Details"),
